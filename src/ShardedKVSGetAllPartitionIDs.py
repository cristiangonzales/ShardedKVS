...
"""
    Function that will return all the partition IDs in the network view. Services HTTP GET requests only.
    :return HTTP response
"""
class ShardedKVSGetAllPartitionIDs(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            return Response(
                json.dumps({
                    'msg': 'success',
                    'partition_id_list': list(partition_dict.keys())
                }),
                status=200,
